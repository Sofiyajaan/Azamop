...
[![Deploy on Heroku](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Sofiyajaan/Azamop)
...
```bash
$ git clone https://github.com/Sofiyajaan/Azamop
$ cd MusicPlayer
$ cp sample.env .env
